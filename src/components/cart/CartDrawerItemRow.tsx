...
export function CartDrawerItemRow({
  ...
  return (
    <article className="flex gap-3 border-b border-gray-100 py-4 last:border-b-0">
      <Link
        href={productHref}
        className="relative h-[72px] w-[72px] shrink-0 overflow-hidden rounded-xl bg-gray-100"
        onClick={() => {
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 text-base font-bold text-ink-800">{formatPrice(item.total, currency)}</p>
