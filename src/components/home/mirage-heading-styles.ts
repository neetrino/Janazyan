...
/** About section — Figma Mirage at 72px */
export const MIRAGE_ABOUT_HEADING_BASE =
  'font-mirage font-normal text-[72px] tracking-[-0.4492px]';

export const MIRAGE_ABOUT_HEADING_SKY_CLASS = `${MIRAGE_ABOUT_HEADING_BASE} leading-[64px] text-sky-soft`;

export const MIRAGE_ABOUT_HEADING_INK_CLASS = `${MIRAGE_ABOUT_HEADING_BASE} leading-[58px] text-ink-800`;
