...
> = {
  ...
  face: {
    src: '/figma/filter-face-icon.svg',
    className: 'h-3.5 w-3.5 desktop:h-4 desktop:w-4',
    width: 14,
    height: 14,
  },
  hair: {
    src: '/figma/filter-hair-icon.svg',
    className: 'h-3.5 w-[13px] desktop:h-4 desktop:w-[15px]',
    width: 13,
    height: 14,
  },
  body: {
    src: '/figma/filter-body-icon.svg',
    className: 'h-3.5 w-2.5 desktop:h-4 desktop:w-3',
    width: 10,
    height: 14,
  },
  kids: {
    src: '/figma/filter-kids-icon.svg',
    className: 'h-4 w-4 desktop:h-5 desktop:w-5',
    width: 16,
    height: 16,
  },
