/**
 * Server-safe skeleton for the products category strip.
 */
export function CategoryNavigationStripSkeleton() {
  return (
    <div className="border-b border-black/5 py-3 sm:py-4 md:py-6 w-full" aria-busy="true">
