...
function MobileBottomNavPanel({ pathname }: { pathname: string }) {
  ...
  return (
    <nav
      className={`${STOREFRONT_TABLET_DOWN_CLASS} fixed bottom-0 inset-x-0 z-[70] px-2 pt-1 pb-[calc(0.5rem+env(safe-area-inset-bottom,0px))]${catalogSurface ? ' bg-sky-mist' : ''}`}
    >
