...
/**
 * PUT /api/v1/admin/partner-store-regions/[id]
 */
export async function PUT(
  ...
  try {
    ...
    const result = await adminService.updatePartnerStoreRegion(id, body);
    await afterMutation();
...
/**
 * DELETE /api/v1/admin/partner-store-regions/[id]
 */
export async function DELETE(
  ...
  try {
    ...
    const { id } = await params;
    await adminService.deletePartnerStoreRegion(id);
    await afterMutation();
