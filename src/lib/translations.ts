...
export const translations = {
  en: {
    ...
    wishlist: {
      ...
      emptyDescription: 'Start adding products to your favorites to save them for later.',
  ...
  hy: {
    ...
    wishlist: {
      ...
      empty: 'Ձեր նախընտրածները դատարկ են',
      emptyDescription: 'Սկսեք ավելացնել ապրանքներ՝ հետագա օգտագործման համար:',
      browseProducts: 'Դիտել ապրանքները',
      remove: 'Հեռացնել',
      items: 'ապրանք',
      item: 'ապրանք',
      totalCount: 'Ընդհանուր ապրանքներ',
    },
    compare: {
  ...
  ru: {
    ...
    wishlist: {
      ...
      emptyDescription: 'Начните добавлять товары в избранное, чтобы сохранить их на потом.',
      browseProducts: 'Просмотреть товары',
      remove: 'Удалить',
      items: 'товаров',
      item: 'товар',
      totalCount: 'Всего товаров',
    },
    compare: {
