...
export const PRODUCTS_CATALOG_GRID_CLASS =
  'grid w-full grid-cols-2 justify-items-center gap-x-1 gap-y-4 sm:grid-cols-3 sm:gap-x-4 sm:gap-y-8 desktop:grid-cols-4 desktop:gap-x-[51px] desktop:gap-y-[44px]';
